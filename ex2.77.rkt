...
z ; z = (complex rectangular 3 . 4)
(magnitude z) ; = apply-generic 'magnitude z= get 'magnitude 'complex z = apply-generic 'magnitude z= get 'magnitude 'rectangular z = (sqrt (+ (square (real-part z)) (square (imag-part z)))))