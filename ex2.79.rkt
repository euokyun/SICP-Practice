...
; 유리수
(define rat1 (make-rational 2 4))
(define rat2 (make-rational 4 8))
(define rat3 (make-rational 1 8))
; 복소수
(define cpx1 (make-complex-from-real-imag 2 4))
(define cpx2 (make-complex-from-mag-ang (magnitude cpx1) (angle cpx1)))
...
(real-part cpx1) ; 2
(real-part cpx2) ; 2.0000000000000004
(imag-part cpx1) ; 4
(imag-part cpx2) ; 4.0
(and (= (real-part cpx1) (real-part cpx2)) (= (imag-part cpx1) (imag-part cpx2))) ; #f

(magnitude cpx1) ; 4.47213595499958
(magnitude cpx2) ; 4.47213595499958
(angle cpx1) ; 1.1071487177940904
(angle cpx2) ; 1.1071487177940904
(and (= (magnitude cpx1) (magnitude cpx2)) (= (angle cpx1) (angle cpx2))) ; #t
